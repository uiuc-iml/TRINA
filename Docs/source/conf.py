...
project = 'TRINA Python API'
copyright = '2021, Intelligent Motion Lab'
author = 'Intelligent Motion Lab'
...
htmlhelp_basename = 'TRINAPythonAPIdoc'
...
latex_documents = [
    (master_doc, 'TRINAPythonAPI.tex', 'TRINA Python API Documentation',
     'Intelligent Motion Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'trinapythonapi', 'TRINA Python API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TRINAPythonAPI', 'TRINA Python API Documentation',
     author, 'TRINAPythonAPI', 'One line description of project.',
     'Miscellaneous'),
]
